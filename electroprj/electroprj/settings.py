"""
Django settings for electroprj project.
...
SECRET_KEY = 'django-insecure-^pej+qi2(b5=%yx0)a)gy&ew^lvtqb6qz)(p(_r+p+w=!oug%w'
...
WSGI_APPLICATION = 'electroprj.wsgi.application'
